...
class ExerciseTableViewController: UITableViewController, ListDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = "\(exercises[indexPath.row].currentOneRepMax) lbs"
